...
const Home = () => {
  ...
  return (
    <>
      <MainLayout>
        {!isLoggedIn ? (
          <div className='bg-sky-400 text-white h-[40vh] py-8 text-center'>
            <h1 className='text-2xl'> Welcome to Task Management WebApp</h1>
            <Link to="/signup" className='mt-10 text-xl block space-x-2 hover:space-x-4'>
              <span className='transition-[margin]'>Click now to manage your tasks</span>
